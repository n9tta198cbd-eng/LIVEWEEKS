...
# Vercel-compatible handler (BaseHTTPRequestHandler format)
# Vercel Python runtime uses BaseHTTPRequestHandler
    ...
    def do_GET(self):
        ...
        try:
            ...
            if cal_type == 'life':
                ...
                # Support both 'lifes' and 'lifespan' for compatibility
