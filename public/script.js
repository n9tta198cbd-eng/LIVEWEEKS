...
const translations = {
    eng: {
        ...
        step6Text: 'In the search type <span class="highlight">wallpaper</span> and select <span class="highlight">Set Photo as Wallpaper</span>',
    ...
    ru: {
        ...
        step6Text: 'В поиске напиши <span class="highlight">обои</span> и выбери <span class="highlight">Установить фото как обои</span>',
